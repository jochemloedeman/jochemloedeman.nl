            ...
            this.innerHTML = `
                <header class="flex w-full overflow-hidden pt-12 pb-4 px-4">
                    <div class="w-full mx-auto flex">
                        <div class="text-gray-800 text-2xl sm:text-4xl font-semibold font-poppins whitespace-nowrap">
                            JOCHEM LOEDEMAN.
                        </div>
                        <div class="container flex justify-end">
                            <div class="flex text-gray-600 items-center">
                                <a class="transition duration-300 font-poppins font-medium text-base sm:text-lg mr-12 text-black hover:text-gray-500" href="/">
                                    Portfolio
                                </a>
                            </div>
                        </div>
